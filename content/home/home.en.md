...
sectionOne:
  ...
  description:
    Aimed at empowering Canadian musicians and artists to make lifelong
...
sectionTwo:
  carouselItems:
    - name: Ida Toninato
      ...
      description:
        “ I realized it’s not a problem that I’m not a tech expert, but
    ...
    - name: KWiat
      description:
        “By hosting a livestream on Twitch, I explored and created some
    ...
    - name: Remy Rodden
      ...
      nameAlt: Pathwaves Ambassador
      description:
        '"I entered the incubator with a solid degree of comfort around
    ...
    - name: Ziyan Hossain
      ...
      nameAlt: Pathwaves Ambassador
      description:
        Acting Managing Director at OCAD U CO, the consultancy arm of OCAD
